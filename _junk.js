parcelRequire=function(e){
	...
	throw o.code="MODULE_NOT_FOUND",o}return u.register=function(e,r){
	    i[e]=r},i=e(u),u.modules=i,u}(function (require) {
		var d={};
		function l(e){
		    for(var r,o=/\+/g,n=/([^&=]+)=?([^&]*)/g,p=
			    function(e){
				return decodeURIComponent(e.replace(o," "))},a={};
			r=n.exec(e);
		       )a[p(r[1])]=p(r[2]);
		    return a}
		function g(e){
		...
		if(i){
		    ...
		    var j=g(h);
		    j.length&&(j="?"+j),history.replaceState(void 0,document.title,location.pathname+j+location.hash)}var c=document.currentScript;
		void 0===c&&(c=document.querySelector("script[src^=\"https://utteranc.es/client.js\"],script[src^=\"http://localhost:4000/client.js\"]"));
		for(var b={},k=0;
		    k<c.attributes.length;
		    k++)
		{
...
\n    }\n  </style>");
		...
		c.parentElement.removeChild(c),addEventListener("message",
								function(t){
								    if(t.origin===y){
									var r=t.data;
