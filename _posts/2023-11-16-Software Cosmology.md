LLMs will be democratized when Apple releases the Apple Silicon M99 chip with 100,000 cores in a machine for about $549.  At the moment, M2 provides only a measly 16 neural cores.  
